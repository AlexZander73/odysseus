...
An optional native macOS wrapper is documented separately in
[`docs/macos-desktop.md`](docs/macos-desktop.md) so the core Docker/native
quick-start paths stay unchanged.
